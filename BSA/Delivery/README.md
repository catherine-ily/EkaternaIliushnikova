...
|:---|:---|:---|
| Моделирование требований | `requirements_modeling.drawio` | DFD (диаграмма потоков данных), swimlane (межфункциональная диаграмма), диаграмма состояний, таблицы решений |
| BPMN-диаграммы | `bpmn_diagrams.drawio` | BPMN-модели бизнес-процессов, сравнение с ранее созданными DFD/swimlane, устранение нестыковок |
| User Stories | `user_stories.md` | Пользовательские истории с критериями приёмки и тестовыми сценариями |
| Use Case | `use_case.md` | Сценарии использования, диаграммы акторов и вариантов использования |
